...
* [GitHub Repo](https://github.com/vitejs/vite) ⭐ 82,554 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-27
* [Release Notes](https://github.com/vitejs/vite/blob/main/packages/vite/CHANGELOG.md) ⭐ 82,554 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-27
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite) ⭐ 82,554 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-27 - Scaffolding Your First Vite Project.
* [create-nx-workspace](https://github.com/nrwl/nx) ⭐ 29,271 | 🐛 469 | 🌐 TypeScript | 📅 2026-08-27 - Scaffolding a Nx + React + Vite + Vitest.
...
* [create-awesome-node-app](https://github.com/Create-Node-App/create-node-app) ⭐ 92 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-27 - Scaffolding your project choosing between different templates.
...
* [vite-tailwind-nojs-starter](https://github.com/kometolabs/vite-tailwind-nojs-starter) ⭐ 75 | 🐛 1 | 🌐 HTML | 📅 2026-08-27 - NoJS Tailwind CSS starter template.
...
* [vue-vben-admin](https://github.com/anncwb/vue-vben-admin) ⭐ 33,247 | 🐛 83 | 🌐 Vue | 📅 2026-08-27 - Background management template based on Vue3, Ant-Design-Vue, TypeScript.
...
* [vite-ts-tailwind-starter](https://github.com/Uninen/vite-ts-tailwind-starter) ⭐ 473 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-27 - TypeScript, Tailwind CSS, Cypress.io e2e tests + CI.
...
* [naive-ui-dashboard-template](https://github.com/Innei/naive-ui-dashboard-template) ⭐ 59 | 🐛 7 | 🌐 HTML | 📅 2026-08-27 - UI friendly, Vue 3 + TSX + Tailwind CSS 2 JIT + PostCSS + Naive UI.
...
* [create-react-app-vite](https://github.com/laststance/create-react-app-vite) ⭐ 161 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-27 - React, TypeScript, Tailwind CSS, MSW, Vitest, React Testing Library, ESLint, Prettier, GitHub Actions.
...
* [SvelteKit](https://github.com/sveltejs/kit) ⭐ 20,765 | 🐛 834 | 🌐 JavaScript | 📅 2026-08-27 - The fastest way to build Svelte apps.
...
* [HuLa](https://github.com/HuLaSpark/HuLa) ⭐ 7,692 | 🐛 23 | 🌐 Vue | 📅 2026-08-15 - is a desktop instant messaging app built on `Vite 5` + `Vue 3` + `TypeScript` + `Tauri` (not just instant messaging).
...
* [github-action-template](https://github.com/hywax/github-action-template) ⭐ 27 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-27 - Starter template for GitHub Actions, TypeScript, ESLint, Vitest, Husky, Conventional Commits.
...
* [`@storybook/builder-vite`](https://github.com/storybookjs/storybook/tree/next/code/builders/builder-vite/) ⭐ 90,949 | 🐛 1,774 | 🌐 TypeScript | 📅 2026-08-27 - Storybook builder.
* [@vitejs/plugin-legacy](https://github.com/vitejs/vite/tree/main/packages/plugin-legacy) ⭐ 82,554 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-27 - Legacy browser support.
...
* [vite-plugin-federation](https://github.com/originjs/vite-plugin-federation) ⭐ 3,045 | 🐛 235 | 🌐 TypeScript | 📅 2025-05-17 - Support Module Federation, Inspired by Webpack Module Federation feature.
...
* [`module-federation/vite`](https://github.com/module-federation/vite) ⭐ 863 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-27 - Official Module Federation integration, enabling dynamic remote module loading.
...
* [@tomjs/vite-plugin-vscode](https://github.com/tomjs/vite-plugin-vscode) ⭐ 93 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Easily use web frameworks to develop `VSCode Extension`'s `Webview`, and support `HMR` and `Debug`.
...
* [@tomjs/vite-plugin-electron](https://github.com/tomjs/vite-plugin-electron) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Easily develop `Electron` applications.
...
* [vite-plugin-dts](https://github.com/qmhc/vite-plugin-dts) ⭐ 1,527 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-25 - Generate declaration files from `.ts` or `.vue` source files for lib.
...
* [vite-plugin-material-symbols](https://github.com/RobinTail/vite-plugin-material-symbols) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27 - Selective loading of Material Symbols font icons based on source code analysis.
...
* [`vitest`](https://github.com/vitest-dev/vitest) ⭐ 17,017 | 🐛 389 | 🌐 TypeScript | 📅 2026-08-27 - A Vite-native test framework.
...
* ![v3] [@vitejs/plugin-vue](https://github.com/vitejs/vite-plugin-vue) ⭐ 677 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27 - Official Vue 3 support.
* ![v3] [@vitejs/plugin-vue-jsx](https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue-jsx) ⭐ 677 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27 - Official Vue 3 JSX support.
...
* ![v23] [vite-plugin-pages](https://github.com/hannoeru/vite-plugin-pages) ⭐ 2,078 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-27 - File system based route generator.
...
* ![v3] [vite-svg-loader](https://github.com/jpkleemans/vite-svg-loader) ⭐ 701 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-26 - Load SVG files as Vue components.
...
* ![v3] [unplugin-vue-i18n](https://github.com/intlify/bundle-tools/tree/main/packages/unplugin-vue-i18n) ⭐ 270 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-27 - Integration for Vue I18n.
...
* [vite-plugin-svelte](https://github.com/sveltejs/vite-plugin-svelte) ⭐ 1,040 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-27 - Adds Svelte support. Official plugin of Svelte team.
...
* [vite-plugin-ruby](https://github.com/ElMassimo/vite_ruby/tree/main/vite-plugin-ruby) ⭐ 1,591 | 🐛 47 | 🌐 Ruby | 📅 2026-08-27 - Configuration for Ruby backends.
* [Vite Ruby](https://github.com/ElMassimo/vite_ruby) ⭐ 1,591 | 🐛 47 | 🌐 Ruby | 📅 2026-08-27 - Integration for Rails, Hanami, Padrino, and Rack apps.
...
* [Astro](https://github.com/withastro/astro) ⭐ 62,097 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-27 - Modern Static Site Builder.
* [Slidev](https://github.com/slidevjs/slidev) ⭐ 48,303 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-25 - Presentation Slides for Developers.
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,250 | 🐛 310 | 🌐 TypeScript | 📅 2026-08-27 - Static Site Generator powered by Vite and Vue.
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,415 | 🐛 195 | 🌐 TypeScript | 📅 2026-08-22 - Framework for building web extensions, with the same DX as Nuxt.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,282 | 🐛 140 | 🌐 TypeScript | 📅 2026-08-27 - Open Source Firebase Alternative with GraphQL.
