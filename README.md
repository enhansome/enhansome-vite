...
* [GitHub Repo](https://github.com/vitejs/vite) ⭐ 82,964 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-23
* [Release Notes](https://github.com/vitejs/vite/blob/main/packages/vite/CHANGELOG.md) ⭐ 82,964 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-23
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite) ⭐ 82,964 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-23 - Scaffolding Your First Vite Project.
* [create-nx-workspace](https://github.com/nrwl/nx) ⭐ 29,367 | 🐛 490 | 🌐 TypeScript | 📅 2026-09-23 - Scaffolding a Nx + React + Vite + Vitest.
...
* [vue-vben-admin](https://github.com/anncwb/vue-vben-admin) ⭐ 33,509 | 🐛 47 | 🌐 Vue | 📅 2026-09-22 - Background management template based on Vue3, Ant-Design-Vue, TypeScript.
* [vue-pure-admin](https://github.com/xiaoxian521/vue-pure-admin) ⭐ 20,647 | 🐛 2 | 🌐 Vue | 📅 2026-08-23 - Background management template based on Vue3, TypeScript, Tailwind CSS, element-plus.
...
* [naive-ui-dashboard-template](https://github.com/Innei/naive-ui-dashboard-template) ⭐ 59 | 🐛 7 | 🌐 HTML | 📅 2026-09-22 - UI friendly, Vue 3 + TSX + Tailwind CSS 2 JIT + PostCSS + Naive UI.
...
* [template-vite-react](https://github.com/lzm0x219/template-vite-react) ⭐ 199 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - A minimal React Vite starter template.
...
* [vite-rtk-query](https://github.com/laststance/vite-rtk-query) ⭐ 152 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-22 - React, TypeScript, Redux Toolkit, RTK Query, Tailwind CSS, MSW, Jest, React Testing Library, ESLint, Prettier.
...
* [SvelteKit](https://github.com/sveltejs/kit) ⭐ 20,826 | 🐛 804 | 🌐 JavaScript | 📅 2026-09-22 - The fastest way to build Svelte apps.
...
* [electron-vite-react](https://github.com/electron-vite/electron-vite-react) ⭐ 2,435 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-01 - Electron + Vite + React template.
...
* [fast-vite-nestjs-electron](https://github.com/ArcherGu/fast-vite-nestjs-electron) ⭐ 374 | 🐛 2 | 🌐 Vue | 📅 2026-09-23 - Vue3 + Vite + Electron + Nestjs with esbuild.
...
* [vite-plugin-doubleshot](https://github.com/Doubleshotjs/doubleshot/tree/main/packages/plugin-vite) ⭐ 210 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - For building Node.js backend or Electron main process.
...
* [HuLa](https://github.com/HuLaSpark/HuLa) ⭐ 7,732 | 🐛 24 | 🌐 Vue | 📅 2026-09-11 - is a desktop instant messaging app built on `Vite 5` + `Vue 3` + `TypeScript` + `Tauri` (not just instant messaging).
...
* [`@storybook/builder-vite`](https://github.com/storybookjs/storybook/tree/next/code/builders/builder-vite/) ⭐ 91,135 | 🐛 1,835 | 🌐 TypeScript | 📅 2026-09-23 - Storybook builder.
* [@vitejs/plugin-legacy](https://github.com/vitejs/vite/tree/main/packages/plugin-legacy) ⭐ 82,964 | 🐛 794 | 🌐 TypeScript | 📅 2026-09-23 - Legacy browser support.
...
* [`module-federation/vite`](https://github.com/module-federation/vite) ⭐ 874 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Official Module Federation integration, enabling dynamic remote module loading.
...
* [vite-plugin-wasm-pack](https://github.com/nshen/vite-plugin-wasm-pack) ⭐ 274 | 🐛 24 | 🌐 TypeScript | 📅 2024-07-31 - Integration with rust [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,282 | 🐛 397 | 🌐 Rust | 📅 2026-08-12, the simple way.
...
* [@spiriit/vite-plugin-svg-spritemap](https://github.com/SpiriitLabs/vite-plugin-svg-spritemap) ⭐ 123 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-31 - Pack your SVG files in one spritemap file and use them with `<svg>`/`<img>` and directly in your CSS.
...
* [genaicode/vite-plugin](https://github.com/gtanczyk/genaicode/tree/master/src/vite-genaicode/) ⭐ 47 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-22 - A plugin that embeds an AI coding assistant into the app UI.
...
* [@mistjs/vite-plugin-px2viewport](https://github.com/aibayanyu20/vite-plugins/tree/main/packages/px2viewport) ⭐ 22 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - A plugin that automatically converts inline styles and style files from px units to vw units.
...
* [vite-plugin-graphql-server](https://github.com/mammadataei/vite-plugin-graphql-server) ⭐ 10 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23 - Bootstrap a local GraphQL server for testing and documentaion.
* [Vite-plugin-graphiql](https://github.com/mammadataei/vite-plugin-graphiql) ⭐ 8 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23 - Integration for GraphiQL IDE.
...
* [vite-plugin-year](https://github.com/8hobbies/vite-plugin-year) ⭐ 4 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-23 - Inserts the current year to the HTML file during build. Useful for adding a copyright year to the HTML file.
...
* [unplugin-icons](https://github.com/antfu/unplugin-icons) ⭐ 4,940 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-11 - Access thousands of icons as components.
...
* [@responsive-image/vite-plugin](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-23 - Transform and generate optimized responsive images (WebP, AVIF) and LQIP placeholders for use with image components.
...
* [vite-plugin-dts](https://github.com/qmhc/vite-plugin-dts) ⭐ 1,528 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - Generate declaration files from `.ts` or `.vue` source files for lib.
...
* [vite-plugin-image-optimizer](https://github.com/FatehAK/vite-plugin-image-optimizer) ⭐ 517 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-23 - Optimize (compress) your image assets using Sharp.js and SVGO at build time.
...
* [unplugin-imagemin](https://github.com/ErKeLost/unplugin-imagemin) ⭐ 261 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-23 - High performance compressed Picture based on squoosh and sharp.
...
* [vite-plugin-ts-nameof](https://github.com/Shinigami92/vite-plugin-ts-nameof) ⭐ 23 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-23 - Ability to resolve [nameof](https://github.com/dsherret/ts-nameof) ⚠️ Archived in TypeScript.
...
* [vite-tsconfig-paths](https://github.com/aleclarson/vite-tsconfig-paths) ⭐ 1,630 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - Support for TypeScript's path mapping.
...
* [vite-plugin-deadfile](https://github.com/stauren/vite-plugin-deadfile) ⭐ 48 | 🐛 6 | 🌐 TypeScript | 📅 2025-03-26 - Find unused source files in the project.
...
* [vite-plugin-valibot-env](https://github.com/idleberg/vite-plugin-valibot-env) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-14 - Validate environment variables against a Valibot schema.
...
* [`vitest`](https://github.com/vitest-dev/vitest) ⭐ 17,151 | 🐛 440 | 🌐 TypeScript | 📅 2026-09-23 - A Vite-native test framework.
...
* [cypress-vite](https://github.com/mammadataei/cypress-vite) ⭐ 106 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - Run Cypress specs using Vite.
...
* ![v3] [@vitejs/plugin-vue](https://github.com/vitejs/vite-plugin-vue) ⭐ 682 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-22 - Official Vue 3 support.
* ![v3] [@vitejs/plugin-vue-jsx](https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue-jsx) ⭐ 682 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-22 - Official Vue 3 JSX support.
...
* ![v23] [vite-plugin-pages](https://github.com/hannoeru/vite-plugin-pages) ⭐ 2,077 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-22 - File system based route generator.
...
* ![v3] [unplugin-vue-i18n](https://github.com/intlify/bundle-tools/tree/main/packages/unplugin-vue-i18n) ⭐ 270 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-23 - Integration for Vue I18n.
...
* ![v23] [unplugin-vue-components](https://github.com/antfu/unplugin-vue-components) ⭐ 4,294 | 🐛 148 | 🌐 TypeScript | 📅 2026-05-20 - On-demand components auto-importing.
...
* [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react) ⭐ 1,164 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-22 - Official React support that uses Babel.
...
* [vite-plugin-svelte](https://github.com/sveltejs/vite-plugin-svelte) ⭐ 1,042 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-23 - Adds Svelte support. Official plugin of Svelte team.
...
* [vite-plugin-solid](https://github.com/amoutonbrady/vite-plugin-solid) ⭐ 521 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-20 - Provides JSX transformation for Solid.
...
* [electron-vite](https://github.com/alex8088/electron-vite) ⭐ 5,613 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-18 - An Electron CLI integrated with Vite.
...
* [Vike](https://github.com/vikejs/vike) ⭐ 5,831 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-23 - Like Nuxt/Next.js but as a do-one-thing-do-it-well plugin. ![react] ![vue3] ![vue2] ![svelte]
...
* [vavite](https://github.com/cyco130/vavite) ⭐ 568 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22 - A tool for developing and building server-side applications with live reloading capabilities.
...
* [vite-plugin-vercel](https://github.com/magne4000/vite-plugin-vercel) ⭐ 129 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-23 - Vercel adapter.
...
* [Viject](https://github.com/bhbs/viject) ⭐ 277 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-20 - One-shot migration tool from Create React App.

## Projects Using Vite.js

### Open Source

* [Astro](https://github.com/withastro/astro) ⭐ 62,763 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-23 - Modern Static Site Builder.
* [Slidev](https://github.com/slidevjs/slidev) ⭐ 48,812 | 🐛 206 | 🌐 TypeScript | 📅 2026-09-16 - Presentation Slides for Developers.
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,346 | 🐛 312 | 🌐 TypeScript | 📅 2026-09-22 - Static Site Generator powered by Vite and Vue.
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,536 | 🐛 220 | 🌐 TypeScript | 📅 2026-09-18 - Framework for building web extensions, with the same DX as Nuxt.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,298 | 🐛 181 | 🌐 Go | 📅 2026-09-23 - Open Source Firebase Alternative with GraphQL.
...
* [macOS in Svelte](https://github.com/PuruVJ/macos-web/) ⭐ 2,671 | 🐛 45 | 🌐 Svelte | 📅 2026-07-05 - macOS Desktop experience for Web in Svelte.
