...
* [GitHub Repo](https://github.com/vitejs/vite) ⭐ 82,945 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-22
* [Release Notes](https://github.com/vitejs/vite/blob/main/packages/vite/CHANGELOG.md) ⭐ 82,945 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-22
...
* [create-vite](https://github.com/vitejs/vite/tree/main/packages/create-vite) ⭐ 82,945 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-22 - Scaffolding Your First Vite Project.
* [create-nx-workspace](https://github.com/nrwl/nx) ⭐ 29,364 | 🐛 492 | 🌐 TypeScript | 📅 2026-09-22 - Scaffolding a Nx + React + Vite + Vitest.
* [bati](https://github.com/batijs/bati) ⭐ 485 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-08 - Scaffolding a Vike project.
* [create-vite-app](https://github.com/ErKeLost/create-vite-app) ⭐ 246 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-21 - Scaffolding Your Out Of The Box Vite Project.
...
* [vite-vanilla-js-template](https://github.com/Barata-Ribeiro/vite-vanilla-js-template) ⭐ 75 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-21 - Starter template ESlint, Prettier, PostCSS, Nesting, Autoprefixer, CSS Nano, CSS Reset.
...
* [vue-vben-admin](https://github.com/anncwb/vue-vben-admin) ⭐ 33,505 | 🐛 45 | 🌐 Vue | 📅 2026-09-21 - Background management template based on Vue3, Ant-Design-Vue, TypeScript.
* [vue-pure-admin](https://github.com/xiaoxian521/vue-pure-admin) ⭐ 20,646 | 🐛 2 | 🌐 Vue | 📅 2026-08-23 - Background management template based on Vue3, TypeScript, Tailwind CSS, element-plus.
...
* [vite-ts-tailwind-starter](https://github.com/Uninen/vite-ts-tailwind-starter) ⭐ 474 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-22 - TypeScript, Tailwind CSS, Cypress.io e2e tests + CI.
...
* [create-react-app-vite](https://github.com/laststance/create-react-app-vite) ⭐ 162 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 - React, TypeScript, Tailwind CSS, MSW, Vitest, React Testing Library, ESLint, Prettier, GitHub Actions.
* [vite-rtk-query](https://github.com/laststance/vite-rtk-query) ⭐ 153 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-22 - React, TypeScript, Redux Toolkit, RTK Query, Tailwind CSS, MSW, Jest, React Testing Library, ESLint, Prettier.
...
* [SvelteKit](https://github.com/sveltejs/kit) ⭐ 20,822 | 🐛 811 | 🌐 JavaScript | 📅 2026-09-22 - The fastest way to build Svelte apps.
...
* [fast-vite-nestjs-electron](https://github.com/ArcherGu/fast-vite-nestjs-electron) ⭐ 374 | 🐛 3 | 🌐 Vue | 📅 2026-09-22 - Vue3 + Vite + Electron + Nestjs with esbuild.
...
* [vite-plugin-doubleshot](https://github.com/Doubleshotjs/doubleshot/tree/main/packages/plugin-vite) ⭐ 210 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-22 - For building Node.js backend or Electron main process.
...
* [HuLa](https://github.com/HuLaSpark/HuLa) ⭐ 7,725 | 🐛 24 | 🌐 Vue | 📅 2026-09-11 - is a desktop instant messaging app built on `Vite 5` + `Vue 3` + `TypeScript` + `Tauri` (not just instant messaging).
...
* [`@storybook/builder-vite`](https://github.com/storybookjs/storybook/tree/next/code/builders/builder-vite/) ⭐ 91,126 | 🐛 1,844 | 🌐 TypeScript | 📅 2026-09-22 - Storybook builder.
* [@vitejs/plugin-legacy](https://github.com/vitejs/vite/tree/main/packages/plugin-legacy) ⭐ 82,945 | 🐛 789 | 🌐 TypeScript | 📅 2026-09-22 - Legacy browser support.
...
* [vite-plugin-electron](https://github.com/electron-vite/vite-plugin-electron) ⭐ 918 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Integrate Vite and Electron.
* [`module-federation/vite`](https://github.com/module-federation/vite) ⭐ 874 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-21 - Official Module Federation integration, enabling dynamic remote module loading.
...
* [vite-plugin-wasm-pack](https://github.com/nshen/vite-plugin-wasm-pack) ⭐ 274 | 🐛 24 | 🌐 TypeScript | 📅 2024-07-31 - Integration with rust [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,284 | 🐛 397 | 🌐 Rust | 📅 2026-08-12, the simple way.
* [vite-plugin-comlink](https://github.com/mathe42/vite-plugin-comlink) ⭐ 238 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-19 - Use WebWorkers with the power of [Comlink](https://github.com/GoogleChromeLabs/comlink) ⭐ 12,794 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-18 to make them enjoyable.
...
* [vite-plugin-graphql-server](https://github.com/mammadataei/vite-plugin-graphql-server) ⭐ 10 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-21 - Bootstrap a local GraphQL server for testing and documentaion.
* [Vite-plugin-graphiql](https://github.com/mammadataei/vite-plugin-graphiql) ⭐ 8 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-21 - Integration for GraphiQL IDE.
...
* [@responsive-image/vite-plugin](https://github.com/simonihmig/responsive-image) ⭐ 210 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22 - Transform and generate optimized responsive images (WebP, AVIF) and LQIP placeholders for use with image components.
...
* [vite-plugin-image-optimizer](https://github.com/FatehAK/vite-plugin-image-optimizer) ⭐ 517 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-19 - Optimize (compress) your image assets using Sharp.js and SVGO at build time.
...
* [vite-plugin-turbo-console](https://github.com/yuyinws/vite-plugin-turbo-console) ⭐ 708 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-22 - Enhance the readability of `console.log()`.
...
* [vite-plugin-ts-nameof](https://github.com/Shinigami92/vite-plugin-ts-nameof) ⭐ 23 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-21 - Ability to resolve [nameof](https://github.com/dsherret/ts-nameof) ⚠️ Archived in TypeScript.
...
* [vite-plugin-material-symbols](https://github.com/RobinTail/vite-plugin-material-symbols) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - Selective loading of Material Symbols font icons based on source code analysis.
...
* [vite-plugin-watch-and-run](https://github.com/jycouet/kitql/tree/main/packages/vite-plugin-watch-and-run) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - Watch some files (glob) and trigger a command. To enable any tool to have a watch mode.
* [vite-plugin-mock-dev-server](https://github.com/pengzhanbo/vite-plugin-mock-dev-server) ⭐ 258 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-19 - Mock server for development, support CJS/ESM/JSON, auto-importing file and HMR.
...
* [`vitest`](https://github.com/vitest-dev/vitest) ⭐ 17,143 | 🐛 432 | 🌐 TypeScript | 📅 2026-09-22 - A Vite-native test framework.
...
* ![v23] [vite-plugin-pages](https://github.com/hannoeru/vite-plugin-pages) ⭐ 2,077 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-22 - File system based route generator.
...
* ![v3] [unplugin-vue-i18n](https://github.com/intlify/bundle-tools/tree/main/packages/unplugin-vue-i18n) ⭐ 270 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-21 - Integration for Vue I18n.
...
* [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react) ⭐ 1,163 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-21 - Official React support that uses Babel.
...
* [vite-plugin-svelte](https://github.com/sveltejs/vite-plugin-svelte) ⭐ 1,041 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-22 - Adds Svelte support. Official plugin of Svelte team.

#### Helpers

* [vite-plugin-kit-routes](https://github.com/jycouet/kitql/tree/main/packages/vite-plugin-kit-routes) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - Generates a file with all the routes, params, actions of your SvelteKit App.
...
* [electron-vite](https://github.com/alex8088/electron-vite) ⭐ 5,610 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-18 - An Electron CLI integrated with Vite.
...
* [Vike](https://github.com/vikejs/vike) ⭐ 5,830 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-22 - Like Nuxt/Next.js but as a do-one-thing-do-it-well plugin. ![react] ![vue3] ![vue2] ![svelte]
...
* [vite-plugin-ruby](https://github.com/ElMassimo/vite_ruby/tree/main/vite-plugin-ruby) ⭐ 1,592 | 🐛 32 | 🌐 Ruby | 📅 2026-09-21 - Configuration for Ruby backends.
* [Vite Ruby](https://github.com/ElMassimo/vite_ruby) ⭐ 1,592 | 🐛 32 | 🌐 Ruby | 📅 2026-09-21 - Integration for Rails, Hanami, Padrino, and Rack apps.
...
* [vite-asset-collector for TYPO3](https://github.com/s2b/vite-asset-collector) ⭐ 57 | 🐛 9 | 🌐 PHP | 📅 2026-09-22 - Backend integration for TYPO3 CMS.
* [vite-plugin-typo3](https://github.com/s2b/vite-plugin-typo3) ⭐ 11 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-21 - Frontend integration for TYPO3 CMS.
...
* [vite-express](https://github.com/szymmis/vite-express) ⭐ 814 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-31 - Integration for Express web apps.
...
* [Astro](https://github.com/withastro/astro) ⭐ 62,747 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-22 - Modern Static Site Builder.
* [Slidev](https://github.com/slidevjs/slidev) ⭐ 48,795 | 🐛 206 | 🌐 TypeScript | 📅 2026-09-16 - Presentation Slides for Developers.
* [VitePress](https://github.com/vuejs/vitepress) ⭐ 18,344 | 🐛 310 | 🌐 TypeScript | 📅 2026-09-22 - Static Site Generator powered by Vite and Vue.
* [WXT](https://github.com/wxt-dev/wxt) ⭐ 10,530 | 🐛 219 | 🌐 TypeScript | 📅 2026-09-18 - Framework for building web extensions, with the same DX as Nuxt.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,295 | 🐛 177 | 🌐 Go | 📅 2026-09-22 - Open Source Firebase Alternative with GraphQL.
...
* [macOS in Svelte](https://github.com/PuruVJ/macos-web/) ⭐ 2,670 | 🐛 45 | 🌐 Svelte | 📅 2026-07-05 - macOS Desktop experience for Web in Svelte.
